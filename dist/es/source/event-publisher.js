...
export class EventPublisher {
    async publish(event, entity, actor) {
...
async function insertEvent(entity, event, actor, version, position, db) {
    await db.query('INSERT INTO "events" (entity_id, entity_type, name, details, actor, version, position) VALUES ($1, $2, $3, $4, $5, $6, $7)', [entity.id, entity.type, event.name, JSON.stringify(event.details), actor, version.value, position]);
}
async function getLastPosition(db) {
...
async function getVersion(entity, db) {
